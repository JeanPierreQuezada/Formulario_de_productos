...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let bodegaValido = false;
    let sucursalValido = false;
    let monedaValido = false;
    ...
    // Validar activación del botón de envío
    btnEnviar.addEventListener("mouseover", function () {
        ...
        console.log(materialValido);
        console.log(bodegaValido);
        console.log(sucursalValido);
        console.log(monedaValido);
        clearTimeout(timeoutId);
    ...
    // Guardar Producto en DB - INCOMPLETO
